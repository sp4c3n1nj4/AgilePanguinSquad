...
#define UE_PROJECT_NAME Experimental
#define UE_TARGET_NAME ExperimentalEditor
#define UE_MODULE_NAME "Experimental"
...
#define EXPERIMENTAL_API DLLEXPORT
